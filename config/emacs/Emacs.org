...
Enable [[https://www.emacswiki.org/emacs/UndoTree][Undo Tree]] mode for simpler undo-redo (and visual branches!).
Other minor tweaks, regarding smooth (and smooth scroll for Emacs >= 29), delete-selection mode to overwrite selected regions, and drag-stuff to...drag stuff around.
