...
This file bootstraps package manager and other utilities. The core of this configuration starts from here.

#+include: "lisp/packages.el" src emacs-lisp :tangle no
...
#+include: "lisp/appearance.el" src emacs-lisp :tangle no
