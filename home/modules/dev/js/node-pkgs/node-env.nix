...
let
  ...
  buildNodePackage = { name, packageName, version ? null, dependencies ? [ ]
    , buildInputs ? [ ], production ? true, npmFlags ? "", dontNpmInstall ? true
    , bypassCache ? false, reconstructLock ? false, preRebuild ? ""
    , dontStrip ? true, unpackPhase ? "true", buildPhase ? "true", meta ? { }
    , ... }@args:
  ...
  buildNodeDependencies = { name, packageName, version ? null, src
    ...
    , dontNpmInstall ? true, bypassCache ? false, reconstructLock ? false
  ...
  buildNodeShell = { name, packageName, version ? null, src, dependencies ? [ ]
    , buildInputs ? [ ], production ? true, npmFlags ? "", dontNpmInstall ? true
    , bypassCache ? false, reconstructLock ? false, dontStrip ? true
