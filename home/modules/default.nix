{
  ...
  "desktop/services/locker-wayland" =
    import ./desktop/services/locker-wayland.nix;
  "desktop/services/waybar" = import ./desktop/services/waybar.nix;

  "/dev/c-c++" = import ./dev/cc.nix;
  "/dev/javascript" = import ./dev/js;
  "/dev/java" = import ./dev/java.nix;
  "/dev/nix-lang" = import ./dev/nix-lang.nix;
  ...
  "themes/materia" = import ./themes/materia;
  "themes/adwaita" = import ./themes/adwaita;
